...
RECOMMENDED_PLUGINS=(
  "github-sync:GitHub Sync (auto-commit and push)"
  "obsidian-git:Obsidian Git (alternative git sync)"
...
echo "  3. Configure GitHub Sync plugin with your preferred interval"
echo "  4. Verify hooks: claude config list (check hooks section)"
echo ""
